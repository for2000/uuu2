...
UUID=${UUID:-'8833fc3f-9b78-43ff-b638-e5732814f41d'}
VMESS_WSPATH=${VMESS_WSPATH:-'/8833fc3f-9b78-43ff-b638-e5732814f41d-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/8833fc3f-9b78-43ff-b638-e5732814f41d-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/8833fc3f-9b78-43ff-b638-e5732814f41d-trojan'}
SS_WSPATH=${SS_WSPATH:-'/8833fc3f-9b78-43ff-b638-e5732814f41d-shadowsocks'}
